...
import com.ekin.system.appservice.department.DepartmentAppService;
...
public class DepartmentController {
    ...
    @Autowired
    public DepartmentController(DepartmentAppService service, DepartmentQueryMapper mapper) {
